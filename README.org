...
* TODO define home (使用xdg代替)

#+begin_src emacs-lisp 
  (defcustom user-config-home (getenv "XDG_CONFIG_HOME") "use xdg config directory")
  (defcustom user-data-home (getenv "XDG_DATA_HOME") "use xdg data directory")
  (defcustom user-state-home (getenv "XDG_STATE_HOME") "use xdg state directory")
  (defcustom user-cache-home (getenv "XDG_CACHE_HOME") "use xdg cache directory")

  (defcustom user-emacs-config-home (concat user-config-home "/emacs") "emacs config directory")
  (defcustom user-emacs-data-home (concat user-data-home "/emacs") "emacs data directory")
  (defcustom user-emacs-state-home (concat user-state-home "/emacs") "emacs state directory")
  (defcustom user-emacs-cache-home (concat user-cache-home "/emacs") "emacs cache directory")
#+end_src
...
#+begin_src emacs-lisp
  ...
  (use-package emacs
    ...
    (setq user-emacs-directory user-emacs-config-home)
    (setq bookmark-default-file (concat user-emacs-data-home "/bookmarks"))
    (setq auto-save-list-file-prefix  (concat user-emacs-state-home "/auto-save-list/.saves-"))
...
#+begin_src emacs-lisp
  (defun reload-config ()
    ...
    (interactive)
    (progn
      (org-babel-tangle-file (concat user-emacs-config-home  "README.org")
      (load-file (concat user-emacs-config-home "/init.el"))
      )
    )
  (defun meow-setup ()
...
#+begin_src emacs-lisp
  ;; (use-package linum-node)
  ;; (use-package netease-cloud-music
  ;;     :requires (netease-cloud-music netease-cloud-music-ui)
  ;;   )
#+end_src
** pocket
用于阅读和管理稍后阅读列表的
    ...
    (setq elfeed-protocol-feeds
          '(
            ("fever+https://grass@rss.grass.work:30443"
             ...
             :password (shell-command-to-string "rbw get miniflux-fever"))
            ))
...
#+begin_src emacs-lisp 
  ...
  (use-package saveplace
    :ensure nil
    :init
    (setq save-place-file (concat user-emacs-state-home "/places"))
  ...
  (use-package recentf
    ...
    :init
    (setq
     recentf-save-file (concat user-emacs-state-home "/recentf")
  ...
  (use-package savehist
    ...
    :init
    (setq savehist-file (concat user-emacs-data-home "/history"))
    (savehist-mode)
    )
...
#+begin_src emacs-lisp 
  (use-package magit
    ...
    :ensure nil
    :config
    (setq project-list-file (concat user-emacs-state-home "/projects"))
    :bind
    (:map project-keymap
  ...
  (use-package projectile
    ...
    :config
    (setq
     projectile-known-projects-file (concat user-emacs-state-home "/projectile-known-projects.eld")
...
#+begin_src emacs-lisp 
  ...
  (use-package tramp
    ...
    (setq tramp-persistency-file-name (concat user-emacs-state-home "/tramp")))
