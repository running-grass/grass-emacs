...
#+begin_src emacs-lisp
  ...
  (use-package org
    ...
    (setq
     ...
     org-refile-targets '(
                          ("~/org/gtd/task.org" :level . 1)
                          ("~/org/gtd/project.org" :maxlevel . 2)
  ...
  (use-package org-caldav
    ...
    (setq
     ...
     org-caldav-calendars (list (list
                                 ...
                                 :files (list (expand-file-name "gtd/task.org" org-directory) (expand-file-name "gtd/project.org" org-directory) )
                                 :inbox "~/org/gtd/caldav-personal.org")
                                (list
                                 ...
                                 :inbox "~/org/gtd/caldav-family.org"))
